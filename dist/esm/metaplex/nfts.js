...
const getMetadataDatas = (nftAddresses, heliusApiKey) =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (nftAddresses.length > 100) {
            ...
            return yield axios.all(axiosRequests).then(responses => {
                const metadata = {
                    data: [],
                };
            ...
            return yield axios.post(url, { mintAccounts: nftAddresses });
        }
    });
export const getParsedNftAccountsByOwner = (connection, owner, heliusApiKey) =>
    __awaiter(void 0, void 0, void 0, function* () {
...
export const getParsedTokenAccountsByOwner = (owner, connection) =>
    __awaiter(void 0, void 0, void 0, function* () {
        const { value: splAccounts } =
            yield connection.getParsedTokenAccountsByOwner(owner, {
                programId: SPL_TOKEN_PROGRAM_ID,
